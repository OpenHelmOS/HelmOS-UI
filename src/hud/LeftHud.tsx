...
import { CrosshairLocation } from "./left/CrosshairLocation";
...
export function LeftHud({ center }: Props) {
  return (
    <div className="fixed left-4 bottom-[var(--bottom-bar-height)] z-10">
      <Collapsible.Root defaultOpen>
        ...
        <Collapsible.Content
            ...
            <div
                ...
                "
            >
                <CrosshairLocation center={center} />
                <Divider />
