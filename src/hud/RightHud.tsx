...
import { ViewModeControl } from "./right/ViewModeControl";
import { CameraControl } from "./right/CameraControl";
...
function Divider() {
  return <div className="h-px bg-white/10 mx-2" />;
}
